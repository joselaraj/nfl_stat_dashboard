  ...
  <div>
    ...
    >
      ...
      <div className="table-wrapper">
        <table className="kickers-table">
          <thead>
            <tr>
              <th>Player</th>
              <th>Team</th>
              <th onClick={() => handleSort('games_played')} className="sortable">GP{arrow('games_played')}</th>
              <th onClick={() => handleSort('fg_made')} className="sortable">FG Made{arrow('fg_made')}</th>
              <th onClick={() => handleSort('fg_att')} className="sortable">FG Attempts{arrow('fg_att')}</th>
              <th onClick={() => handleSort('gwfg_made')} className="sortable">Game Winning FG{arrow('gwfg_made')}</th>
            ...
            {paginatedPlayers.map((p, i) => (
              ...
              <td style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                ...
                />
                  ...
                  onClick={() => navigate(`/k/${encodeURIComponent(p.player_id)}/detail`)}
                >
                ...
                <td>{p.fg_made}</td>
                <td>{p.fg_att}</td>
                <td className="highlight">{p.gwfg_made}</td>
